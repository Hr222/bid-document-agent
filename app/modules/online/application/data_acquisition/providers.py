...
class InlineChecklistDataProvider:
    ...
    def collect(self, request: ChecklistDataAcquisitionRequest) -> ChecklistDataPack:
        ...
        return ChecklistDataPack(
            ...
            provided_input_fields=(self._submitted_materials_label,)
            if has_effective_materials
            else (),
            missing_input_fields=(self._submitted_materials_label,)
    ...
    def _build_insufficient_reason(
        ...
        *,
        ...
        if has_effective_materials:
            return None
        if self._submitted_materials_field_key not in request.checklist_request.provided_fields:
