...
from app.schemas import OcrProcessResult, ParsedBlock, ParsedDocumentResult
...
class PolicyOcrService:
    ...
    def _reserve_request_slot(
        ...
        *,
        ...
        if wait_seconds > 0:
            logger.info(
                "OCR request throttled block_id=%s page_no=%s wait_seconds=%.2f interval_seconds=%.2f",
                block_id,
                page_no,
                wait_seconds,
